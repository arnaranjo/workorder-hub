...
public interface WorkOrderGateway {
     ...
     */
    List<WorkOrderElement> getWorkFrontList();
     ...
     */
    List<WorkOrderElement> getAssignedWorkList(int employeeId);
     ...
     */
    List<WorkOrderElement> getClosedWorkList(LocalDate startDate);
